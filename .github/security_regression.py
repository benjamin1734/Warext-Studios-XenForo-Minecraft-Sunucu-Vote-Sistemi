...
require('_output/templates/public/warext_mc_server_add.html', ['Sunucu tanıtım konusu', 'Görsel Kimlik', 'Ana sunucu adresi', 'Crossplay', '468×60', '1200×400'])
...
require('Service/Server/Media.php', ["'width' => 468", "'height' => 60", "'width' => 1200", "'height' => 400", 'processAnimatedGif', 'cropThumbnailImage', 'imagewebp', 'max_output', 'copyFileToAbstractedPath'])
